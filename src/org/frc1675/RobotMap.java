...
//setpoints
    public static final int FLOOR_ANGLE = 253;  //degrees
    ...
    public static final int TRUSS_ANGLE = ((STARTING_ANGLE + FORWARD_SHOOT_ANGLE) / 2) - 2;
...
//auton stuff
    ...
    public static class DashboardDefaults {
        ...
        public static final int TWO_BALL_FIRST_ANGLE = 70;
        public static final int TWO_BALL_SECOND_ANGLE = 64;
