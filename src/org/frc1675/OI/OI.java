...
public class OI {
    ...
    public OI() {
        XBoxControllerButtons.driverLeftBumper.whenPressed(new DriveSelection(true));
        XBoxControllerButtons.driverLeftBumper.whenReleased(new DriveSelection(false));
        XBoxControllerButtons.driverRightBumper.whenPressed(new ShiftGears());
        ...
        XBoxControllerButtons.driverA.whenPressed(new SetDriveCommand(RobotMap.TANK_DRIVE));
        XBoxControllerButtons.driverB.whenPressed(new SetDriveCommand(RobotMap.ARCADE_DRIVE));
        XBoxControllerButtons.driverX.whenPressed(new SetDriveCommand(RobotMap.CHEESY_DRIVE));
    }
    
    public final void setDefaultCommands(){
        XBoxControllerButtons.driverA.whenPressed(new NoDriveCommand());
        XBoxControllerButtons.driverB.whenPressed(new PuncherPutPinIn());
        XBoxControllerButtons.operatorX.whenPressed(new NoDriveCommand());
    }
