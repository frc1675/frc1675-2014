...
import org.frc1675.commands.drives.VectorArcadeDriveCommand;
...
public class DriveBase extends Subsystem {
    ...
    public void setArcadeDrive() {
        setDefaultCommand(new VectorArcadeDriveCommand());
        System.out.println("Robot Set to Arcade Drive"); //Robot Set to Arcade Drive");
